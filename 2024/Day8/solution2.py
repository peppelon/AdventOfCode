    ...
    for antenna_set in antenna_coords.values():
        for i, antenna1 in enumerate(antenna_set):
            for j, antenna2 in enumerate(antenna_set[i:]):
                ...
                # add the antennas too
                resonance_coords.add(antenna1)
                resonance_coords.add(antenna2)

                i = 1
                while True:
                    resonance1 = (antenna1[0] + i * x_dist, antenna1[1] + i * y_dist)
                ...
                j = 1    
                while True:
                    resonance2 = (antenna2[0] - j * x_dist, antenna2[1] - j * y_dist)
